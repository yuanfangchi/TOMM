...
def read_options(test_name):
    ...
    parsed['pretrained_embeddings_action_dir'] = parsed['output_dir'] + '/pretrained_embeddings_action.txt'
    parsed['pretrained_embeddings_entity_dir'] = parsed['output_dir'] + '/pretrained_embeddings_entity.txt'
